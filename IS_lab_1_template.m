...
e(indx)= T(indx) - y;
w1 = w1 + e(indx)*eta*x1(indx);
w2 = w2 + e(indx)*eta*x2(indx);
b = b + eta*e(indx);
end
E2 =sum(abs(e));
...
E1(indx)= T(indx) - y;
w1 = w1 + E1(indx)*eta*x1(indx);
w2 = w2 + E1(indx)*eta*x2(indx);
b = b + eta*E1(indx);
   end
   E2 = sum(abs(E1));
end

x3=[hsv_value_A1 hsv_value_A2 hsv_value_A3 hsv_value_P1 hsv_value_P2];
x4=[metric_A4 metric_A5 metric_A6 metric_P2 metric_P3];

for indx=1:5;  
v = x3(indx)*w1 + x4(indx)*w2 + b;
if v > 0
	y = 1;
else
	y = -1;
